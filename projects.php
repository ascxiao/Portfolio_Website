        ...
        <div class="row no-gutters m-0 p-0">
            ...
            <div class="col-xl-10 col-12">
                    ...
                    <div class="row">
                        <div class = "content_container" id = "project_page">                    
                            <div class = "col-12" height = "100%">
                                <?php include('pages/projects/project_landing.php')?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row d-flex align-items-center align-content-center justify-content-center">
                    <div class = "content_container" style = "background-color: #4e6151;" id = "ui">
                        <div class = "col-12" height = "100%">
                            <?php include('pages/projects/ui.php'); ?>
                        </div>
                    </div>
                </div>

                <div class="row d-flex align-items-center align-content-center justify-content-center">
                    <div class = "content_container" id = "art">
                        <div class = "col-12" height = "100%">
                            <?php include('pages/projects/art.php'); ?>
                        </div>
                    </div>
                </div>

                <div class="row d-flex align-items-center align-content-center justify-content-center">
                    <div class = "content_container" style = "background-color: #4e6151;" id = "game">
                        <div class = "col-12" height = "100%">
                            <?php include('pages/projects/game.php'); ?>
                        </div>
                    </div>
                </div>
